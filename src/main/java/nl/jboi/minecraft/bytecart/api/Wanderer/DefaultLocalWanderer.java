...
public class DefaultLocalWanderer<T extends InventoryContent> extends AbstractWanderer {
    ...
    protected nl.jboi.minecraft.bytecart.api.Wanderer.RoutingTable RoutingTable = null;
    ...
    public void doAction(IntersectionSide.Side to) {
        ...
        if (to.Value() != IntersectionSide.Side.LEVER_ON.Value() && this.getNetmask() < ByteCartAPI.MAXSTATIONLOG) {
